...
from hyperParametersTuning.train_validation_svc import TrainValidationSVC
...
save_path = os.path.join(os.path.realpath("../../../../.."), "submission/sklearn/train_validation/svc.csv")
train_validation_svc = TrainValidationSVC(X_resampled, X_validation,
                                          y_resampled, y_validation,
                                          save_path)
train_validation_svc.run()
