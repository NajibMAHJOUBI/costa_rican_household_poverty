...
from grid_search.grid_search_cv import GridSearchCVTask
...
# Train Validation -
print("Grid Search CV process")
grid_search_cv = GridSearchCVTask(4, "random_forest", "f1_macro")
grid_search_cv.define_estimator()
