...
# Train Validation k Nearest Neighbors
save_path = None
if chi2_option:
    save_path = os.path.join(os.path.realpath("../../../../../.."), "submission/sklearn/train_validation/categorical/nearest_neighbors/chi2_features")
else:
    save_path = os.path.join(os.path.realpath("../../../../../.."), "submission/sklearn/train_validation/categorical/nearest_neighbors/all_features")
