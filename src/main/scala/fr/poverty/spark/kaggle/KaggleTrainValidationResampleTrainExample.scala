...
import fr.poverty.spark.sampleMethod.upSampleMinorityClass.UpSampleMinorityClassTask

import scala.io.Source


object KaggleTrainValidationResampleTrainExample {
  ...
  def main(arguments: Array[String]): Unit = {
    ...
    val upMinoritySample = new UpSampleMinorityClassTask(targetColumn)
