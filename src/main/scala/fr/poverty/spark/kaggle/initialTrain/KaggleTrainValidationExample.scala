    ...
    trainRatioList.foreach(trainRatio => {
      ...
      models.foreach(model =>{
        ...
        if (model == "decisionTree") {
          val decisionTree = new TrainValidationDecisionTreeTask(labelColumn, featureColumn, predictionColumn, metricName,s"$savePath/$model", trainRatio)
          ...
          val randomForest = new TrainValidationRandomForestTask(labelColumn, featureColumn, predictionColumn, metricName, s"$savePath/$model", trainRatio)
          ...
          val logisticRegression = new TrainValidationLogisticRegressionTask(labelColumn, featureColumn, predictionColumn, metricName,s"$savePath/$model", trainRatio)
          ...
          val naiveBayes = new TrainValidationNaiveBayesTask(labelColumn, featureColumn, predictionColumn, metricName, s"$savePath/$model", trainRatio,
            false)
