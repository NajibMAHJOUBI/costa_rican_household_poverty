...
class UpSampleMinorityClassTaskTest extends AssertionsForJUnit  {
  ...
  @Test def testDataSetClass(): Unit = {
    val upMinoritySample = new UpSampleMinorityClassTask(labelColumn)
    val classList = upMinoritySample.dataSetClass(spark, data)
  ...
  @Test def testCountByClass(): Unit = {
    val upMinoritySample = new UpSampleMinorityClassTask(labelColumn)
    val countClass = upMinoritySample.countByClass(spark, data)
